...
################################################################################
## Form generated from reading UI file 'interfaceLnAJwX.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.resultTable.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.resultTable.setAutoFillBackground(False)
        self.resultTable.setFrameShadow(QFrame.Shadow.Plain)
        self.resultTable.setLineWidth(1)
        self.resultTable.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.resultTable.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        self.resultTable.setTextElideMode(Qt.TextElideMode.ElideLeft)
        self.resultTable.setShowGrid(True)
        self.resultTable.setGridStyle(Qt.PenStyle.NoPen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Number of occurrences", None));
        ...
        self.chartButton.setText(QCoreApplication.translate("MainWindow", u"Generate bar chart", None))
    # retranslateUi
